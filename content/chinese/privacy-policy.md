...
DocumentChat uses artificial intelligence powered by Google Gemini to analyze your documents and generate answers to your questions. The following information describes how your data is processed for this service:

**Service Description**
Google Gemini is an AI service that analyzes document content and chat messages to generate contextual responses and insights. This service is provided by Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA.

**Data Processed**
When you use the AI chat feature, the following personal data is transmitted:
- Document content (text from your uploaded documents)
- Chat messages (your questions and conversation history)
...
**Purpose**
The purpose of this data transmission is to provide AI-powered document analysis and question answering functionality within the DocumentChat application.

**Legal Basis**
The legal basis for this processing is Article 6(1) lit. a GDPR (explicit consent). You must affirmatively consent to AI data processing before any data is sent to Google Gemini. This consent is requested in-app before your first chat message.
...
**User Control**
You can decline AI data processing in the consent dialog when you first use the chat feature. If you decline, the app will not send your data to Google Gemini, but some features may be unavailable.
